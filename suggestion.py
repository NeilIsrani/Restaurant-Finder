...
def suggest_midpoint_activity(
    ...
    # Only calculate exact ETAs for the top half
    max_candidates = 5
    if len(activity_scores) > 1 and len(activity_scores) < 10:
        max_candidates = len(activity_scores) // 2
    """ elif max_candidates < 2:
        max_candidates = 1
 """
